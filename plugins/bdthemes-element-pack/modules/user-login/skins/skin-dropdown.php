		...
		if ( is_user_logged_in() && ! Element_Pack_Loader::elementor()->editor->is_edit_mode() ) {
			...
			<?php if ($settings['show_logged_in_content']) : ?>
				...
				<?php else : ?>
                    ...
                    ?>
					<a class="bdt-logout-button bdt-button bdt-button-primary echo $settings['redirect_logOut_url']['url'];" href="<?php echo wp_logout_url( $logout_url ); ?>" class="bdt-ul-logout-menu">
