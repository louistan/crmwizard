...
class User_Login extends Module_Base {
      ...
      <div <?php echo $this->get_render_attribute_string('dropdown-settings'); ?>>
        ...
        <ul class="bdt-nav bdt-dropdown-nav">
            <?php if ( $settings['show_edit_profile'] ) : ?>
              <li><a href="<?php echo get_edit_user_link(); ?>"><span class="bdt-ul-custom-nav-icon"><i
                        class="ep-edit fa-fw"></i></span> <?php esc_html_e('Edit Profile', 'bdthemes-element-pack'); ?>
                </a></li>
            <?php endif; ?>
          ...
          <li>
            <a href="<?php echo wp_logout_url($logout_url); ?>" class="bdt-ul-logout-menu"><span
                  class="bdt-ul-custom-nav-icon"><i
                    class="ep-lock fa-fw"></i></span> <?php esc_html_e('Logout', 'bdthemes-element-pack'); ?>
                </a>
            </li>
        </ul>
      </div>
              ...
              <div class="bdt-user-login bdt-text-center">
                <ul class="bdt-list bdt-list-divider">
                  ...
                  <li class="bdt-user-website">
                      <?php esc_html_e('Website:', 'bdthemes-element-pack'); ?> <a
                        href="<?php echo esc_url($current_user->user_url); ?>"
                        target="_blank"><?php echo esc_url($current_user->user_url); ?></a>
                  </li>
                  ...
                  <li class="bdt-user-logged-out">
                    ...
                    <a href="<?php echo wp_logout_url($logout_url); ?>" 
                       class="bdt-button bdt-button-primary"><?php esc_html_e('Logout', 'bdthemes-element-pack'); ?></a>
                  </li>
                </ul>
    ...
    public function social_login() {
        ...
        <div class="bdt-width-1-1 bdt-width-1-2@s bdt-position-relative">
                ...
                <div <?php echo $this->get_render_attribute_string('facebook-login'); ?>>
								<a href="javascript:void(0);" data-appid="<?php echo esc_attr($gl_app_id) ?>" class="fb_btn_link"><span
                      class="bdt-facebook-icon"><i
                        class="ep-facebook fa-fw"></i></span> <?php echo esc_html('Facebook'); ?></a>
							</div>
              <?php endif; ?>

                <?php if ( 'yes' == $settings['show_google_login'] ) : ?>
                  <div class="bdt-google">
								<a href="javascript:void(0);" data-clientid="<?php echo esc_attr($gl_app_id) ?>"
                   id="google_btn_link"><span class="bdt-google-icon"><i
                        class="ep-google fa-fw"></i></span> <?php echo esc_html('Google'); ?></a>
							</div>
                <?php endif; ?>
    ...
    public function user_login_form() {
        ...
        ?>
      <form
          id="bdt-user-login<?php echo esc_attr($id); ?>" <?php echo $this->get_render_attribute_string('login-form-wrapper'); ?>
          method="post">
        ...
        <input type="hidden" name="redirect_after_login" value="<?php echo esc_url($redirect_url) ?>"
        ...
        <div <?php echo $this->get_render_attribute_string('field-group'); ?>>
            ...
            if ( $settings['show_labels'] ) {
                ?>
              <label <?php echo $this->get_render_attribute_string('user_label'); ?>>
          ...
          <?php if ( $settings['show_remember_me'] ) : ?>
            <div class="bdt-field-group bdt-remember-me">
              <label for="remember-me-<?php echo esc_attr($id); ?>" class="bdt-form-label">
                <input type="checkbox" id="remember-me-<?php echo esc_attr($id); ?>" class="bdt-checkbox"
